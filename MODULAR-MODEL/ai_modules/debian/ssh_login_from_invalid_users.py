"""SSH Login from Invalid Users
Category: Authentication
Level: High
Description: Login attempts for non-existent users, indicating possible reconnaissance or misconfiguration.
"""
...
if __name__ == "__main__":
    ...
    if detect(sample_logs):
        print("SSH Login from Invalid Users detected!")
    else:
